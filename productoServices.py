...
class ProductoService:
    ...
    def busqueda_binaria(self, listado, precio_buscado):
        lista_ordenada = self.insertion_sort_precio(listado, 'ascendente')
        izquierda = 0
        ...
        while izquierda <= derecha:
            ...
            if elementoDelMedio == precio_buscado:
                return lista_ordenada[indiceDelElementoDelMedio]
            if precio_buscado < elementoDelMedio:
